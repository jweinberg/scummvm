...
void XcodeProvider::createWorkspace(const BuildSetup &setup) {
	std::ofstream workspace((setup.outputDir + '/' + "scummvm.pbxproj").c_str());
	if (!workspace)
		error("Could not open \"" + setup.outputDir + '/' + "scummvm.pbxproj\" for writing");
	...
	for (UUIDMap::const_iterator i = _uuidMap.begin(); i != _uuidMap.end(); ++i) {
		...
		workspace << "\t\t<Project filename=\"" << i->first << ".xcodeproj\" />\n";
	}
...
void XcodeProvider::createProjectFile(const std::string &name, const std::string &, const BuildSetup &setup, const std::string &moduleDir,
...
void XcodeProvider::writeWarnings(const std::string &name, std::ofstream &output) const {
...
void XcodeProvider::writeDefines(const StringList &defines, std::ofstream &output) const {
...
void XcodeProvider::writeReferences(std::ofstream &output) {
...
const char *XcodeProvider::getProjectExtension() {
	return ".pbxproj";
}
